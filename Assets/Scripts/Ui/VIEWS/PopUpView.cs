...
public class PopUpView : UiView
{
    ...
    private Transform scopeRootToRestore;
    ...
    private void OnDisable()
    {
        ...
        ControllerNavigationHelper.Instance.SetScope(scopeRootToRestore);
        scopeRootToRestore = null;
    }
    ...
    public void ActivePopUpView(PopUpInformation popUpInfo)
    {
        ...
        ActiveView();
        scopeRootToRestore = ControllerNavigationHelper.Instance.currentSelectionRoot;
        ControllerNavigationHelper.Instance.SetScope(transform);
    }
